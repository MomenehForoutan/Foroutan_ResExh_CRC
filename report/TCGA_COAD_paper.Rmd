...
##---- if checking the Str sigs
# 
# exhStrCan <- c(exhSigs_Str, canSigs)
# trmStrCan <- c(trmSigs_Str, canSigs)
# 
# 
# for(s in trmSigs_Str){
#   for(e in exhStrCan){
#     currentColumn <- paste(s, e, sep = "--")
#     wide2Comb[, currentColumn] <- paste(wide2Comb[, s], s , "&",
#                                       wide2Comb[, e], e)
...
CD8NK_Exh_Bulk--NK_Res_Bulk:
High CD8NK_Exh_Bulk & Low NK_Res_Bulk vs Low CD8NK_Exh_Bulk & High NK_Res_Bulk

```{r}
# cc <- "CD8NK_Exh_Bulk--NK_Res_Bulk"
# 
# currentCox <- cox_OS_2Comb_Extremes6_sig[
#   cox_OS_2Comb_Extremes6_sig$VariableName == cc , ]
# 
# annot <-
...
# 
# 
# cc <- "CD8_Exh_Bulk--NK_Res_Bulk"
# ## Low CD8_Exh_Bulk & High NK_Res_Bulk - High CD8_Exh_Bulk & Low NK_Res_Bulk
# 
# currentCox <- cox_OS_2Comb_Extremes6_sig[
#   cox_OS_2Comb_Extremes6_sig$VariableName == cc , ]
# 
...
#   wide2CombLong[wide2CombLong$Comb_Name == cc &
#                 wide2CombLong$Comb_2status %in% c(
#                   "High CD8_Exh_Bulk & Low NK_Res_Bulk", "Low CD8_Exh_Bulk & High NK_Res_Bulk"), ]
# 
# 
