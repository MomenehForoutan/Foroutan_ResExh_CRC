...
# James' gut atlas
We downloaded the data rfom Human Gut Atlas by James et al, and generated the Seurat object (see the commnented code below) which includes the data for NK and T cells only. Here we read the Seurat object, and subset to NK cells.
