...
selSigs <- c(
  list(
    ...
    NK_Res_Bulk = NK_ResMarkerCanPass,

    CD4_Exh_Bulk = c(CD4_ExhMarkerCanPass),
    CD4_Res_Bulk = c(CD4_ResMarkerCanPass),

    CD8_Exh_Bulk = c(CD8_ExhMarkerCanPass),
    CD8_Res_Bulk = c(CD8_ResMarkerCanPass),
    
    All_Exh_Bulk = All_Exh_CancerPass,
    All_Res_Bulk = All_Res_CancerPass,
    
    CD8NK_Exh_Bulk = CD8NK_Exh,
    CD8NK_Res_Bulk = CD8NK_Res
